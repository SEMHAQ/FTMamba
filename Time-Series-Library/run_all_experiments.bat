...
for %%P in (96 192 336 720) do (
    ...
    python -u run.py --task_name long_term_forecast --is_training 1 --root_path ./dataset/ETT-small/ --data_path ETTh1.csv --model_id ETTh1_%%P_%%P --model DLinear --data ETTh1 --features M --seq_len %SEQ_LEN% --label_len %LABEL_LEN% --pred_len %%P --enc_in 7 --dec_in 7 --c_out 7 --batch_size %BATCH_SIZE% --des FTMamba_Exp --itr %ITR%

    echo --- TimesNet ETTh1 pred_len=%%P ---
    python -u run.py --task_name long_term_forecast --is_training 1 --root_path ./dataset/ETT-small/ --data_path ETTh1.csv --model_id ETTh1_%%P_%%P --model TimesNet --data ETTh1 --features M --seq_len %SEQ_LEN% --label_len %LABEL_LEN% --pred_len %%P --e_layers %E_LAYERS% --d_layers %D_LAYERS% --enc_in 7 --dec_in 7 --c_out 7 --d_model %D_MODEL% --d_ff %D_FF% --n_heads %N_HEADS% --top_k 5 --num_kernels 6 --dropout %DROPOUT% --batch_size %BATCH_SIZE% --des FTMamba_Exp --itr %ITR%
...
for %%P in (96 192 336 720) do (
    ...
    python -u run.py --task_name long_term_forecast --is_training 1 --root_path ./dataset/ETT-small/ --data_path ETTh2.csv --model_id ETTh2_%%P_%%P --model DLinear --data ETTh2 --features M --seq_len %SEQ_LEN% --label_len %LABEL_LEN% --pred_len %%P --enc_in 7 --dec_in 7 --c_out 7 --batch_size %BATCH_SIZE% --des FTMamba_Exp --itr %ITR%
...
for %%P in (96 192 336 720) do (
    ...
    python -u run.py --task_name long_term_forecast --is_training 1 --root_path ./dataset/ETT-small/ --data_path ETTm1.csv --model_id ETTm1_%%P_%%P --model DLinear --data ETTm1 --features M --seq_len %SEQ_LEN% --label_len %LABEL_LEN% --pred_len %%P --enc_in 7 --dec_in 7 --c_out 7 --batch_size %BATCH_SIZE% --des FTMamba_Exp --itr %ITR%
...
for %%P in (96 192 336 720) do (
    ...
    python -u run.py --task_name long_term_forecast --is_training 1 --root_path ./dataset/weather/ --data_path weather.csv --model_id weather_%%P_%%P --model DLinear --data custom --features M --seq_len %SEQ_LEN% --label_len %LABEL_LEN% --pred_len %%P --enc_in 21 --dec_in 21 --c_out 21 --batch_size %BATCH_SIZE% --des FTMamba_Exp --itr %ITR%
